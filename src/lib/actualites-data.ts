...
export const actualites: Actualite[] = [
  {
    ...
    images: [
      "/images/actualites/post4-1.webp",
      "/images/actualites/post4-2.webp",
      "/images/actualites/post4-3.webp",
      "/images/actualites/post4-4.webp",
      "/images/actualites/post4-5.webp",
      "/images/actualites/post4-6.webp",
    ],
...
📩 Si vous développez une activité dans le tourisme ou gérez plusieurs hébergements, nous serions ravis d'échanger.`,
  ...
  },
  {
    ...
    images: [
      "/images/actualites/post3-1.webp",
      "/images/actualites/post3-2.webp",
      "/images/actualites/post3-3.webp",
      "/images/actualites/post3-4.webp",
      "/images/actualites/post3-5.webp",
    ],
...
C'est sur cette logique que Nova Baie a été construite. Nous concevons des sites web premium pour les professionnels du tourisme, avec une approche simple : valoriser ce qui existe déjà… et le transformer en levier de conversion.`,
    images: [
      "/images/actualites/post2-1.webp",
      "/images/actualites/post2-2.webp",
      "/images/actualites/post2-3.webp",
      "/images/actualites/post2-4.webp",
      "/images/actualites/post2-5.webp",
    ],
    lien: "https://nova-baie.com",
    labelLien: "nova-baie.com",
    plateformes: ["LinkedIn", "Instagram", "Facebook"],
